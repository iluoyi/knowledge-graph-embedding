...
public class TestEmbeddings {
	...
	public static void main(String args[]) throws Exception {
		...
		String CONFIG_PATH = "FB15K_Config.properties";
		...
		readEmbeddings(EN_EMBD_FILE_PATH, RE_EMBD_FILE_PATH, DIMENSION,
				bestEntityEmbeddings, bestRelationEmbeddings);
		load(TRAIN_FILE_PATH, TEST_FILE_PATH, testExamples, goldTriplets,
				entitySet);
		System.out.println("Done loading...");
		System.out.println();
		System.out.println("Start testing...");
		AvgRankHitAtTenBean result = test(entitySet, goldTriplets,
				bestEntityEmbeddings, bestRelationEmbeddings, NORM,
				testExamples);
		System.out.println("Done testing...");

		System.out.println("****************************");
		System.out.println("RAW_RANK: "
				+ (result.totalRawHeadRank + result.totalRawTailRank) * 1.0
				/ (2 * testExamples.size()));
		System.out.println("FILTER_RANK: "
				+ (result.totalFilterHeadRank + result.totalFilterTailRank)
				* 1.0 / (2 * testExamples.size()));
		System.out.println("RAW_HIT@10: "
				+ (result.totalRawHeadHit10 + result.totalRawTailHit10) * 1.0
				/ (2 * testExamples.size()));
		System.out.println("FILTER_HIT@10: "
				+ (result.totalFilterHeadHit10 + result.totalFilterTailHit10)
				* 1.0 / (2 * testExamples.size()));
	}
