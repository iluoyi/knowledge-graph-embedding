...
public class TransE {
	...
	public TransE() throws Exception
	{	
		/*FB15K Config File*/
...
//			System.out.println(i + " = " + i + ": dev avg loos done.");
	...
	public void test()
	{
		...
		{			
			...
			/*Replace Tail Entity*/
			System.out.println("Replacing the tail of the " + i + "-th of " + testExamples.size() + " triples by " + entitySet.size() + " entities.");
			Iterator<String> entityIt = entitySet.iterator();
			while(entityIt.hasNext())
			{
			...
			System.out.println("Replacing the head of the " + i + "-th of " + testExamples.size() + " triples by " + entitySet.size() + " entities.");
			/*Replace Head Entity*/
...
//		transe.storeEmbeddings();
		...
		/*To read best embbedings*/
		transe.readEmbeddings(transe.EN_EMBD_FILE_PATH, transe.RE_EMBD_FILE_PATH);
